...
export interface SupportTypeDescriptor {
     ...
     *
     * This doc used to read "a shaft running plate-to-model, not one bridging
     * two model contacts" -- which describes a TRUNK and excludes a BRANCH,
     * contradicting the `true` the branch declares. The value is the intent
     * (confirmed): a branch is a shaft and can be braced. The prose was stale.
     *
